...
function init() {
    ...
    var texture = new THREE.TextureLoader().load( 'textures/360-fondo_mariko-5.jpg' );
    ...
    sprite1.position.set(-11, 28, 200);
    ...
    if (features.sfx) {
        audioLib.hotspots["hotspot-1"] = new Audio('./audio/Ishi_SFX_Arts.m4a');
        audioLib.hotspots["hotspot-2"] = new Audio('./audio/Ishi_SFX_Entertainment.m4a');
        audioLib.hotspots["hotspot-3"] = new Audio('./audio/Ishi_SFX_Education.m4a');
        audioLib.hotspots["hotspot-4"] = new Audio('./audio/Ishi_SFX_Phillosophy.m4a');
        audioLib.hotspots["hotspot-5"] = new Audio('./audio/Ishi_SFX_Politics.m4a');

        audioLib.ambient = new Audio('./audio/Ishi_Ambience.m4a');
